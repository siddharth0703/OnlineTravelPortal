		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				<form action="HotelController" method="get">
					...
					<h4>Add Hotels</h4>
					<hr>
					<br> <br><input type="text" class="label" name="hotelid"
						placeholder="HotelID"><br> <br> 
					<input type="text" class="label" name="name"
						placeholder="HotelName"><br> <br> <input
						type="text" class="label" name="city"
						placeholder="HotelCity"><br> <br> <input
						type="text" class="label" name="address" placeholder="Address"><br>
					<br> <input type="text" class="label" name="contactno"
						placeholder="Contact Number"><br> <br>  
						<input type="text" class="label" name="rate"
						placeholder="Rate"><br> <br>  
						<input type="submit" class="btn btn-secondary" name="addHotel"
						value="Add Hotel"><br>
					<br>
					<br>
