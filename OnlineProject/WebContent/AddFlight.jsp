		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				<form action="FlightController" method="get">
					...
					<h4>Add Flights</h4>
					<hr>
					<br> <br> <input type="text" class="label" name="fname"
						placeholder="FlightName"><br> <br> <input
						type="text" class="label" name="fnumber"
						placeholder="FlightNumber"><br> <br> <input
						type="text" class="label" name="forigin" placeholder="Origin"><br>
					<br> <input type="text" class="label" name="fdestination"
						placeholder="Destination"><br> <br> <input
						type="text" class="label" name="ftime"
						placeholder="Departure_Time"><br> <br> <input
						type="text" class="label" name="fstatus" placeholder="Status"><br>
					<br> <input type="text" class="label" name="ffare"
						placeholder="Fare"><br> <br> <input
						type="submit" class="btn btn-secondary" name="addFlight"
						value="Submit"><br>
					<br>
					<br>
					<br> <a href="#menu-toggle" class="btn btn-secondary"
