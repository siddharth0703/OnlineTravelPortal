	...
	<div id="wrapper">
		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				<form action="BikeController" method="get">
					<h4>Add Bikes</h4>
					<hr>
					<br> <br> <input type="text" class="label"
						name="bikename" placeholder="Bike Name"><br> <br>
					<input type="text" class="label" name="bikeid"
						placeholder="Bike Id"><br> <br> <input
						type="text" class="label" name="type" placeholder="Type"><br>
					<br> <input type="text" class="label" name="fare"
						placeholder="Fare"><br> <br> <input
						type="submit" class="btn btn-secondary" name="addBike"
						value="Submit"> <br> <br> <br> <br> <a
						href="#menu-toggle" class="btn btn-secondary" id="menu-toggle">Toggle
						Menu</a>
			</div>
		</div>
