...
<title>Bus Addition Details</title>
</head>
<meta charset="UTF-8">
...
<div class="w3-top">
  <div class="w3-bar w3-teal w3-card w3-left-align w3-large">
    ...
    <a href="template.html" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Bus</a>
    <a href="flight.html" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Flight</a>
    <a href="Train.html" class="w3-bar-item w3-button w3-padding-large w3-white">Train</a>
...
<!-- Header -->
<header class="w3-container w3-teal w3-center" style="padding:2px 10px">
<br><br>
	...
	<form action="BusAdd" method="post">
		<table cellpadding="3pt">
			...
			<tr>
				...
				<td><input type="text" name="b_dCity" size="30" /></td>
			</tr>
			<tr>
				<td>Bus Arrival City</td>
				<td><input type="text" name="b_aCity" size="30" /></td>
			</tr>
			<tr>
				<td>Seats</td>
				<td><input type="text" name="b_seats" size="5" /></td>
			</tr>
			
			<tr>
				<td>Bus Details:</td>
				<td><input type="text" name="b_details" size="10" placeholder="d-MMM-yyyy,HH:mm:ss aaa"></td> 
