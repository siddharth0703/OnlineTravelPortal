		...
		<div id="page-content-wrapper">
			...
			<center>
				<table border="1">
					...
					<tr>
					<th><font color='red'><h4>Bike Name&nbsp;&nbsp;</h4></font>
						</th>
						<th><font color='red'><h4>Bike ID&nbsp;&nbsp;</h4></font>
						</th>
						<th><font color='red'><h4>Type &nbsp;&nbsp;</h4></font></th>
						<th><font color='red'><h4>Fare&nbsp;&nbsp;</h4></font></th>
					</tr>

					<c:forEach items="${bikeList}" var="list">
						<tr>
						    <td><h5>${list.bikeName}</h5></td>
							<td><h5>${list.bikeid}</h5></td>
							<td><h5>${list.type}</h5></td>
				...
				<form action="BikeController" method="POST">
						...
						<select name="bikeid">
							<c:forEach items="${bikeList}" var="bike">
								<option value="${bike.bikeid}">${bike.bikeid}</option>
							</c:forEach>
						</select>
						<br><br>
						<button type="submit" id="deleteBike" class="btn btn-secondary"
							name="deleteBike">Delete</button>
					</form>
</center>
