...
<%  session=request.getSession(false);%>
	...
	<div class="extra_wrapper">
		...
		<center><font color = "black" >
			...
			<h2>24*7 Support & Help</h2> 
			  <font size = "5">
			<h3>LET'S TALK, WE LOVE HEARING FROM YOU </h3>
		</font>		
		</center>
		<br> <br>
		<p>
			<b>Toll Free</b>: 1800 300 3600
		</p>
		<p>
			<b>Email Id</b>: support@oshotravels.com
		</p>
		<br> <br> <br>
		<p>
		<h5>Head Office</h5>
		</p>
		<p>HCL Technologies, Sector 8</p>
		<p>IMT Manesar</p>
