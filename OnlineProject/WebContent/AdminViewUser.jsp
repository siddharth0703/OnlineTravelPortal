		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				...
				<table border='1'>
					...
					<tr>
						<th><font color='black'><h4>Id&nbsp;&nbsp;</h4></font></th>
						<th><font color='black'><h4>Username&nbsp;</h4></font></th>
						<th><font color='black'><h4>Email&nbsp;&nbsp;</h4></font></th>
						<th><font color='black'><h4>Phone&nbsp;&nbsp;</h4></font></th>
						<th><font color='black'><h4>Address&nbsp;&nbsp;</h4></font></th>
						<th><font color='black'><h4>City&nbsp;&nbsp;</h4></font></th>
						<th><font color='black'><h4>ZipCode&nbsp;&nbsp;</h4></font></th>
						</tr>

					<c:forEach items="${userList}" var="list">
						<tr>
							<td><h5>${list.id}</h5></td>
							<td><h5>${list.userName}</h5></td>
							<td><h5>${list.email}</h5></td>
							<td><h5>${list.phone}</h5></td>
							<td><h5>${list.address}</h5></td>
							<td><h5>${list.city}</h5></td>
							<td><h5>${list.zipcode}</h5></td>
						</tr>
					</c:forEach>
				</table>
